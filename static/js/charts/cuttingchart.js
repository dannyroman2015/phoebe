...
// bieu dồ nhỏ trái (tạm thời hidden)
// const y1 = d3.scaleLinear()
...
// svg.append("text")
//   .text(`${target_actual.detail[0].type.toUpperCase()}`)
//   .attr("text-anchor", "middle")
//   .attr("alignment-baseline", "middle")
//   .attr("x", 40)
//   .attr("y", height - 10)
...
// svg.append("text")
//   .text(`${target_actual.detail[1].type.toUpperCase()}`)
//   .attr("text-anchor", "middle")
//   .attr("alignment-baseline", "middle")
//   .attr("x", 90)
//   .attr("y", height - 10)
...
//   .attr("fill", "#A5A0DE")
      // brand actual label
// svg.append("text")
//   .text(`${d3.format(".0f")(prodtypedata[0].qty)}`)
//   .attr("text-anchor", "middle")
//   .attr("alignment-baseline", "middle")
//   .attr("x", 40)
...
//   .attr("font-size", 12)
      // rh actual label
// svg.append("text")
//   .text(`${d3.format(".0f")(prodtypedata[1].qty)}`)
//   .attr("text-anchor", "middle")
//   .attr("alignment-baseline", "middle")
//   .attr("x", 90)
...
//   .attr("font-size", 12)
      // brand % label
// svg.append("text")
//   .text(`${d3.format(".0f")(prodtypedata[0].qty / target_actual.detail[0].target * 100)}%`)
//   .attr("text-anchor", "middle")
//   .attr("alignment-baseline", "middle")
//   .attr("x", 40)
...
//   .attr("font-size", 12)
      // rh % label
// svg.append("text")
//   .text(`${d3.format(".0f")(prodtypedata[1].qty / target_actual.detail[1].target * 100)}%`)
//   .attr("text-anchor", "middle")
//   .attr("alignment-baseline", "middle")
//   .attr("x", 90)
